...
def run_build(parse_args):
    ...
    if bootimage_path:
        ...
        upload.upload_sourceforge(tag, bootimage_name, bootimage_path)
    ...
    if recovery_path:
        ...
        upload.upload_sourceforge(tag, recovery_name, recovery_path)
    ...
    if otapackage_path and target == "otapackage":
        ...
        upload.upload_sourceforge(tag, otapackage_name, otapackage_path)
